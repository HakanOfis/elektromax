    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-black/30 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-[1100px] items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          >
            <span className="relative grid h-9 w-9 place-items-center overflow-hidden rounded-full bg-white/6 ring-1 ring-white/10">
              ...
              <img
                src={logoSrc}
                alt={content.name}
                className="relative h-full w-full object-cover scale-[1.7] scale-x-[2.0]"
              />
            </span>
