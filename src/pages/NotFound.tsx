...
export default function NotFound() {
  return (
    <Layout title="Sayfa bulunamadı | Elektromax" description="Aradığınız sayfa bulunamadı.">
      <div className="mx-auto max-w-2xl rounded-3xl border border-white/10 bg-white/[0.03] p-10 text-center">
        ...
        <h1 className="mt-6 text-2xl font-black tracking-tight md:text-3xl">Sayfa bulunamadı</h1>
        <p className="mt-3 text-sm leading-relaxed text-zinc-200/75">
          Bu bağlantı geçersiz olabilir veya sayfa taşınmış olabilir.
        </p>
